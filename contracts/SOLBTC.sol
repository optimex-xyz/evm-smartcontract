...
/*****************************************************************************************
    @title SOLBTC contract                               
    @dev This contract facilitates trades/swaps from the Solana Network to Bitcoin Network.
...
contract SOLBTC is Core {
    ...
    /**
        ...
        @return A string representing the contract type ("SOLBTC").
    */
    ...
    */
    function submitTrade(
...

        {
            ...
            /// - The presign is also verified by the Vault contract when MPC initiates the trade settlement
            bytes32 pmmId;
        ...
        /// @dev: For SOL->BTC,  `pFeeRate` setting is snapshot, then
    ...
    */
    function selectPMM(
        ...
        /// @dev: For SOL->BTC, protocol fee is calculated when trade is submitted
        /// The PMM is already aware of the protocol fee and the actual trade amount (net amount after fees)
        /// As a result, this constraint differs from the one used in the BTCSOL contract
