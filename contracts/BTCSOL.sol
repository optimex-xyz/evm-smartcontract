...
contract BTCSOL is Core {
    ...
    /**
        ...
        @return A string representing the contract type ("BTCSOL").
    */
    ...
    /** 
        @notice Submits trade data and presigns.
    ...
    */
    function selectPMM(
        ...
        /// @dev: For BTC->SOL, the fee is charged on the Solana side
